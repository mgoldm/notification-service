...
ActiveRecord::Schema[7.1].define(version: 2024_04_11_090213) do
  create_table "notifications", primary_key: "uuid", id: :string, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
